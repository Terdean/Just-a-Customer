...
public class ImportantKeysManager : MonoBehaviour
{
    ...
    //Этот скрипт предназначен для проверки по Всем имеющимся в игре "Важным" для нажатия буквам и если игрок нажмёт на
    //такую важную, то остальные не будут обижаться.
    //+Этот скрипт можно использовать, чтобы не выбирались одинаковые клавиши для управления, ведь здесь буквально список
    //всех Subsequence, которые надо подключить к этому скрипту, а в них самих списки их буковок.
